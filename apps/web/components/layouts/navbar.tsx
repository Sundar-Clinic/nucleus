...
const Navbar = () => {
  ...
  return (
    <header className="bg-foreground border-b-4 border-black sticky top-0 z-50 brutal-shadow">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center w-full justify-center">
            <NavigationMenu className="z-5 bg-foreground border-none space-x-8">
              <NavigationMenuList>
                <NavigationMenuItem>
